 ...
 */
public class ActivityPSAType implements java.io.Serializable {
	 ...
	 * The AP type
	 */
	public static final int APV_TYPE = 0;
	public static final int VN_TYPE = 1;

	/**
	 * The instance of the AP type
	 */
	public static final ActivityPSAType APV = new ActivityPSAType(APV_TYPE,
			"APV");
	public static final ActivityPSAType VN = new ActivityPSAType(VN_TYPE, "VN");
	...
	private ActivityPSAType(int type, java.lang.String value) {
		super();
		this.type = type;
	...
	public static com.inetpsa.boz.rpv.xml.types.ActivityPSAType valueOf(
		...
		if (obj == null) {
			String err = "'" + string + "' is not a valid ActivityPSAType";
