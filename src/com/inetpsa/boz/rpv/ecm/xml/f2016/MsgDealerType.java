...
public class MsgDealerType implements java.io.Serializable {
	 ...
	 * @return boolean
	 */
	public boolean removeLEAD(com.inetpsa.boz.rpv.ecm.xml.f2016.LEAD vLEAD) {
	 ...
	 * @param vLEAD
	 */
	public void setLEAD(int index, com.inetpsa.boz.rpv.ecm.xml.f2016.LEAD vLEAD)
			throws java.lang.IndexOutOfBoundsException {
		// -- check bounds for index
		if ((index < 0) || (index > _LEADList.size())) {
			throw new IndexOutOfBoundsException();
	 ...
	 * @param LEADArray
	 */
	public void setLEAD(com.inetpsa.boz.rpv.ecm.xml.f2016.LEAD[] LEADArray) {
		// -- copy array
		_LEADList.clear();
	...
	public static java.lang.Object unmarshal(java.io.Reader reader)
			throws org.exolab.castor.xml.MarshalException,
			org.exolab.castor.xml.ValidationException {
		return (com.inetpsa.boz.rpv.ecm.xml.f2016.MsgDealerType) Unmarshaller
				.unmarshal(
						com.inetpsa.boz.rpv.ecm.xml.f2016.MsgDealerType.class,
						reader);
