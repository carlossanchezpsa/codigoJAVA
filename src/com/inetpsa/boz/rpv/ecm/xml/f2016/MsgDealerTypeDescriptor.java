...
public class MsgDealerTypeDescriptor extends
	...
	public MsgDealerTypeDescriptor() {
		...
		// -- _LEADList
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(
				com.inetpsa.boz.rpv.ecm.xml.f2016.LEAD.class, "_LEADList",
		...
		handler = new org.exolab.castor.xml.XMLFieldHandler() {
			...
			public void setValue(java.lang.Object object, java.lang.Object value)
				...
				try {
					MsgDealerType target = (MsgDealerType) object;
					target.addLEAD((com.inetpsa.boz.rpv.ecm.xml.f2016.LEAD) value);
				} catch (java.lang.Exception ex) {
					throw new IllegalStateException(ex.toString());
				}
			}
			...
			public java.lang.Object newInstance(java.lang.Object parent) {
				return new com.inetpsa.boz.rpv.ecm.xml.f2016.LEAD();
			}
		};
		desc.setHandler(handler);
	...
	public java.lang.Class getJavaClass() {
		return com.inetpsa.boz.rpv.ecm.xml.f2016.MsgDealerType.class;
