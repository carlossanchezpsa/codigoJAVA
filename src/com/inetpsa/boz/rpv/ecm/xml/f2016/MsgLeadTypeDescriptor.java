...
public class MsgLeadTypeDescriptor extends
	...
	public MsgLeadTypeDescriptor() {
		...
		// -- _Q3Bis
		desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(
				java.lang.String.class, "_Q3Bis", "Q3Bis",
				org.exolab.castor.xml.NodeType.Element);
		desc.setImmutable(true);
		desc.setMatches("Q3BIS Q3Bis"); // Aceptamos que venga la etiqueta
										// completamente en mayúsculas o como
										// Q3Bis
		handler = new org.exolab.castor.xml.XMLFieldHandler() {
			public java.lang.Object getValue(java.lang.Object object)
					throws IllegalStateException {
				MsgLeadType target = (MsgLeadType) object;
				return target.getQ3Bis();
			}
			...
			public void setValue(java.lang.Object object, java.lang.Object value)
				...
				try {
					MsgLeadType target = (MsgLeadType) object;
					target.setQ3Bis((java.lang.String) value);
				} catch (java.lang.Exception ex) {
					throw new IllegalStateException(ex.toString());
				}
			}
	...
	public java.lang.Class getJavaClass() {
		return com.inetpsa.boz.rpv.ecm.xml.f2016.MsgLeadType.class;
