 ...
 */
public class DEALERDescriptor extends MsgDealerTypeDescriptor {
	...
	public DEALERDescriptor() {
		super();
		setExtendsWithoutFlatten(new MsgDealerTypeDescriptor());
		xmlName = "DEALER";
	...
	public java.lang.Class getJavaClass() {
		return com.inetpsa.boz.rpv.ecm.xml.f2016.DEALER.class;
