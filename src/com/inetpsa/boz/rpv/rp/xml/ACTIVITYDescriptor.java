 ...
 */
public class ACTIVITYDescriptor extends MsgActivityTypeDescriptor {
	...
	public ACTIVITYDescriptor() {
		super();
		setExtendsWithoutFlatten(new MsgActivityTypeDescriptor());
		xmlName = "ACTIVITY";
	...
	public java.lang.Class getJavaClass() {
		return com.inetpsa.boz.rpv.rp.xml.ACTIVITY.class;
