...
public class MsgDealerType implements java.io.Serializable {
	...
	public void addQUESTIONNAIRE(
			com.inetpsa.boz.vcm.apv.xml.v4.QUESTIONNAIRE v_QUESTIONNAIRE)
	...
	public boolean removeQUESTIONNAIRE(
			com.inetpsa.boz.vcm.apv.xml.v4.QUESTIONNAIRE vQUESTIONNAIRE) {
	 ...
	 */
	public com.inetpsa.boz.vcm.apv.xml.v4.QUESTIONNAIRE getQUESTIONNAIRE(
		...
		return (com.inetpsa.boz.vcm.apv.xml.v4.QUESTIONNAIRE) _QUESTIONNAIREList
				.get(index);
	}
	...
	public com.inetpsa.boz.vcm.apv.xml.v4.QUESTIONNAIRE[] getQUESTIONNAIRE() {
		...
		com.inetpsa.boz.vcm.apv.xml.v4.QUESTIONNAIRE[] mArray = new com.inetpsa.boz.vcm.apv.xml.v4.QUESTIONNAIRE[size];
		for (int index = 0; index < size; index++) {
			mArray[index] = (com.inetpsa.boz.vcm.apv.xml.v4.QUESTIONNAIRE) _QUESTIONNAIREList
					.get(index);
		}
		return mArray;
	}
	...
	public void setQUESTIONNAIRE(
			com.inetpsa.boz.vcm.apv.xml.v4.QUESTIONNAIRE[] QUESTIONNAIREArray) {
		// -- copy array
		_QUESTIONNAIREList.clear();
	...
	public static java.lang.Object unmarshal(java.io.Reader reader)
			throws org.exolab.castor.xml.MarshalException,
			org.exolab.castor.xml.ValidationException {
		return (com.inetpsa.boz.vcm.apv.xml.v4.MsgDealerType) Unmarshaller
				.unmarshal(com.inetpsa.boz.vcm.apv.xml.v4.MsgDealerType.class,
						reader);
