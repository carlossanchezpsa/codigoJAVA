...
import com.inetpsa.boz.vcm.business.VcmProcess;
...
public class VcmStart {
	...
	public static void main(String[] args) {
		try {
			...
			/*
			 * File[] tabFile =
			 * FileUtils.listFilterFiles(Context.getInputPath(),
			 * Context.getPrefixFileNameAPV());
			 * 
			 * System.out.println(Context.getInputPath() + "--" +
			 * Context.getPrefixFileNameAPV()); for (int i = 0; i <
			 * tabFile.length; i++) { System.out.println(tabFile[i]); }
			 */

			VcmProcess rpvprocess = new VcmProcess();
			rpvprocess.execute();
			// CHECKSTYLE:OFF
		} catch (Exception ex) {
