 ...
 */
package com.inetpsa.boz.vcm.vn.dao;
 ...
 * @author e210954
 */
public class VcmVNDao extends BozDao {

	/** Singleton */
	private static VcmVNDao instance;
	 ...
	 */
	private VcmVNDao(String resource) {
		super(resource);
	}
	 ...
	 */
	public static VcmVNDao getInstance() {
		if (instance == null)
			instance = new VcmVNDao("BOZRPVQUERIES");
		return instance;
	}
	...
	public SuiviModuleBean insert(Connection con,
		...
		try {
			...
			int i = 1;
			ppStmt = con.prepareStatement(getQuery("INSERT_OEVM_VN_V3"));
			...
			for (int j = 0; j < nbDealer; j++) {
				...
				for (int k = 0; k < nbLead; k++) {
					...
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							...
							BozConstants.LEN_Q_SHORT));
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							.getDEALER(j).getQUESTIONNAIRE(k).getQ8(),
							BozConstants.LEN_Q_SHORT));
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
					...
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							...
							BozConstants.LEN_Q_SHORT));
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							.getDEALER(j).getQUESTIONNAIRE(k).getQ11Bis(),
							BozConstants.LEN_Q_SHORT));
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
					...
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							...
							BozConstants.LEN_Q_SHORT));
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							.getDEALER(j).getQUESTIONNAIRE(k).getQ48(),
							BozConstants.LEN_Q_SHORT));
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							.getDEALER(j).getQUESTIONNAIRE(k).getQ49(),
							BozConstants.LEN_Q_SHORT));
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
					...
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							...
							BozConstants.LEN_Q_SHORT));
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							.getDEALER(j).getQUESTIONNAIRE(k).getQ68(),
							BozConstants.LEN_Q_SHORT));
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
					...
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							...
							BozConstants.LEN_Q_SHORT));
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							.getDEALER(j).getQUESTIONNAIRE(k).getQ75(),
							BozConstants.LEN_Q_SHORT));
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
					...
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							...
							BozConstants.LEN_Q_SHORT));
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							.getDEALER(j).getQUESTIONNAIRE(k).getQ82(),
							BozConstants.LEN_Q_SHORT));
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
					...
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							...
							BozConstants.LEN_Q_SHORT));
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							.getDEALER(j).getQUESTIONNAIRE(k).getQ89(),
							BozConstants.LEN_Q_SHORT));
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
					...
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							...
							BozConstants.LEN_Q_SHORT));
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							.getDEALER(j).getQUESTIONNAIRE(k).getQ93(),
							BozConstants.LEN_Q_SHORT));
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							.getDEALER(j).getQUESTIONNAIRE(k).getQ94(),
							BozConstants.LEN_Q_SHORT));
	...
	public SuiviModuleBean insert(Connection con,
		...
		try {
			...
			int i = 1;
			ppStmt = con.prepareStatement(getQuery("INSERT_OEVM_VN_V4"));
			...
			for (int j = 0; j < nbDealer; j++) {
				...
				for (int k = 0; k < nbLead; k++) {
					...
					if (xmlMessage
							.getAP_AC()
							.toString()
							.equals(com.inetpsa.boz.rpv.xml.types.MarquePSAType.AP
									.toString())) {
						ppStmt.setString(
								i++,
								StringUtils.formatString(xmlMessage
										.getDEALER(j).getQUESTIONNAIRE(k)
										.getQ11AP(), BozConstants.LEN_Q_SHORT));
					}
					if (xmlMessage
							.getAP_AC()
							.toString()
							.equals(com.inetpsa.boz.rpv.xml.types.MarquePSAType.AC
									.toString())) {
						ppStmt.setString(
								i++,
								StringUtils.formatString(xmlMessage
										.getDEALER(j).getQUESTIONNAIRE(k)
										.getQ11AC(), BozConstants.LEN_Q_SHORT));
					}
					if (xmlMessage
							.getAP_AC()
							.toString()
							.equals(com.inetpsa.boz.rpv.xml.types.MarquePSAType.DS
									.toString())) {
						ppStmt.setString(
								i++,
								StringUtils.formatString(xmlMessage
										.getDEALER(j).getQUESTIONNAIRE(k)
										.getQ11DS(), BozConstants.LEN_Q_SHORT));
					}
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
							.getDEALER(j).getQUESTIONNAIRE(k).getQ12(),
							BozConstants.LEN_Q_SHORT));
					...
					if (xmlMessage
						...
						ppStmt.setString(
								...
								StringUtils.formatString(xmlMessage
										.getDEALER(j).getQUESTIONNAIRE(k)
										.getQ21AP(), BozConstants.LEN_Q_SHORT));
					}
					if (xmlMessage
							.getAP_AC()
							.toString()
						...
						ppStmt.setString(
								...
								StringUtils.formatString(xmlMessage
										.getDEALER(j).getQUESTIONNAIRE(k)
										.getQ21AC(), BozConstants.LEN_Q_SHORT));
					}
					if (xmlMessage
							.getAP_AC()
							.toString()
						...
						ppStmt.setString(
								...
								StringUtils.formatString(xmlMessage
										.getDEALER(j).getQUESTIONNAIRE(k)
										.getQ21DS(), BozConstants.LEN_Q_SHORT));
					}
					ppStmt.setString(i++, StringUtils.formatString(xmlMessage
