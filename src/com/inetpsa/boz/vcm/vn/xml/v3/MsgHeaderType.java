...
public class MsgHeaderType implements java.io.Serializable {
	 ...
	 * Field _ACTIVITY
	 */
	// private com.inetpsa.boz.rpv.xml.types.ActivityPSAType _ACTIVITY;
	 ...
	 * @param vDEALER
	 */
	public void addDEALER(com.inetpsa.boz.vcm.vn.xml.v3.DEALER vDEALER)
	 ...
	 * @param vDEALER
	 */
	public void addDEALER(int index, com.inetpsa.boz.vcm.vn.xml.v3.DEALER vDEALER)
			throws java.lang.IndexOutOfBoundsException {
	 ...
	 * @return DEALER
	 */
	public com.inetpsa.boz.vcm.vn.xml.v3.DEALER getDEALER(int index)
			throws java.lang.IndexOutOfBoundsException {
		...
		return (com.inetpsa.boz.vcm.vn.xml.v3.DEALER) _DEALERList.get(index);
	 ...
	 * @return DEALER
	 */
	public com.inetpsa.boz.vcm.vn.xml.v3.DEALER[] getDEALER() {
		int size = _DEALERList.size();
		com.inetpsa.boz.vcm.vn.xml.v3.DEALER[] mArray = new com.inetpsa.boz.vcm.vn.xml.v3.DEALER[size];
		for (int index = 0; index < size; index++) {
			mArray[index] = (com.inetpsa.boz.vcm.vn.xml.v3.DEALER) _DEALERList
					.get(index);
		}
		return mArray;
	 ...
	 * @return boolean
	 */
	public boolean removeDEALER(com.inetpsa.boz.vcm.vn.xml.v3.DEALER vDEALER) {
	 ...
	 * @param vDEALER
	 */
	public void setDEALER(int index, com.inetpsa.boz.vcm.vn.xml.v3.DEALER vDEALER)
			throws java.lang.IndexOutOfBoundsException {
		// -- check bounds for index
		if ((index < 0) || (index > _DEALERList.size())) {
			throw new IndexOutOfBoundsException();
	 ...
	 * @param DEALERArray
	 */
	public void setDEALER(com.inetpsa.boz.vcm.vn.xml.v3.DEALER[] DEALERArray) {
		// -- copy array
		_DEALERList.clear();
	...
	public static java.lang.Object unmarshal(java.io.Reader reader)
		...
		return Unmarshaller.unmarshal(
				com.inetpsa.boz.vcm.vn.xml.v3.MsgHeaderType.class, reader);
