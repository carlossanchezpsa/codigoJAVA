...
public class MsgDealerType implements java.io.Serializable {
	...
	public void addQUESTIONNAIRE(
			com.inetpsa.boz.vcm.vn.xml.v3.QUESTIONNAIRE v_QUESTIONNAIRE)
	...
	public boolean removeQUESTIONNAIRE(
			com.inetpsa.boz.vcm.vn.xml.v3.QUESTIONNAIRE vQUESTIONNAIRE) {
	 ...
	 */
	public com.inetpsa.boz.vcm.vn.xml.v3.QUESTIONNAIRE getQUESTIONNAIRE(int index)
			throws java.lang.IndexOutOfBoundsException {
		...
		return (com.inetpsa.boz.vcm.vn.xml.v3.QUESTIONNAIRE) _QUESTIONNAIREList
				.get(index);
	}
	 ...
	 * @return QUESTIONNAIRE
	 */
	public com.inetpsa.boz.vcm.vn.xml.v3.QUESTIONNAIRE[] getQUESTIONNAIRE() {
		int size = _QUESTIONNAIREList.size();
		com.inetpsa.boz.vcm.vn.xml.v3.QUESTIONNAIRE[] mArray = new com.inetpsa.boz.vcm.vn.xml.v3.QUESTIONNAIRE[size];
		for (int index = 0; index < size; index++) {
			mArray[index] = (com.inetpsa.boz.vcm.vn.xml.v3.QUESTIONNAIRE) _QUESTIONNAIREList
					.get(index);
		}
		return mArray;
	}
	...
	public void setQUESTIONNAIRE(
			com.inetpsa.boz.vcm.vn.xml.v3.QUESTIONNAIRE[] QUESTIONNAIREArray) {
		// -- copy array
		_QUESTIONNAIREList.clear();
	...
	public static java.lang.Object unmarshal(java.io.Reader reader)
		...
		return Unmarshaller.unmarshal(
				com.inetpsa.boz.vcm.vn.xml.v3.MsgDealerType.class, reader);
