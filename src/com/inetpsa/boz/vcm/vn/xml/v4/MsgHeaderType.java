...
public class MsgHeaderType implements java.io.Serializable {
	 ...
	 * @param vDEALER
	 */
	public void addDEALER(com.inetpsa.boz.vcm.vn.xml.v4.DEALER vDEALER)
	...
	public void addDEALER(int index,
			com.inetpsa.boz.vcm.vn.xml.v4.DEALER vDEALER)
			throws java.lang.IndexOutOfBoundsException {
	 ...
	 * @return DEALER
	 */
	public com.inetpsa.boz.vcm.vn.xml.v4.DEALER getDEALER(int index)
			throws java.lang.IndexOutOfBoundsException {
		...
		return (com.inetpsa.boz.vcm.vn.xml.v4.DEALER) _DEALERList.get(index);
	 ...
	 * @return DEALER
	 */
	public com.inetpsa.boz.vcm.vn.xml.v4.DEALER[] getDEALER() {
		int size = _DEALERList.size();
		com.inetpsa.boz.vcm.vn.xml.v4.DEALER[] mArray = new com.inetpsa.boz.vcm.vn.xml.v4.DEALER[size];
		for (int index = 0; index < size; index++) {
			mArray[index] = (com.inetpsa.boz.vcm.vn.xml.v4.DEALER) _DEALERList
					.get(index);
		}
		return mArray;
	 ...
	 * @return boolean
	 */
	public boolean removeDEALER(com.inetpsa.boz.vcm.vn.xml.v4.DEALER vDEALER) {
	 ...
	 * @param DEALERArray
	 */
	public void setDEALER(com.inetpsa.boz.vcm.vn.xml.v4.DEALER[] DEALERArray) {
		// -- copy array
		_DEALERList.clear();
	...
	public static java.lang.Object unmarshal(java.io.Reader reader)
		...
		return Unmarshaller.unmarshal(
				com.inetpsa.boz.vcm.vn.xml.v4.MsgHeaderType.class, reader);
